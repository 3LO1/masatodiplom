...
function EditRoomForm({ room, onCancel, onRoomUpdated }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Ошибка при обновлении помещения');
    }
  };
  ...
  return (
    <div style={{ 
      ...
      <h3 style={{ marginTop: 0 }}>Редактировать помещение №{room.room_number}</h3>
